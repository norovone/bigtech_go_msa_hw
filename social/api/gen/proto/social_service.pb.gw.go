...
func RegisterSocialServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SocialServiceServer) error {
	mux.Handle(http.MethodPost, pattern_SocialService_SendFriendRequest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/github.com.norovone.bigtech_go_msa_hw.social.SocialService/SendFriendRequest", runtime.WithHTTPPathPattern("/v1/send_friend_request"))
		if err != nil {
...
func RegisterSocialServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SocialServiceClient) error {
	mux.Handle(http.MethodPost, pattern_SocialService_SendFriendRequest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/github.com.norovone.bigtech_go_msa_hw.social.SocialService/SendFriendRequest", runtime.WithHTTPPathPattern("/v1/send_friend_request"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SocialService_SendFriendRequest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "send_friend_request"}, ""))
)
